...
gj.tree.config = {
    base: {
         ...
         * <script>
         *     var tree = $('#tree').tree({
         *         dataSource: [ { text: 'World', imageUrl: 'http://gijgo.com/other/icons/world-icon.png', children: [ { text: 'USA', imageUrl: 'http://gijgo.com/other/icons/usa-oval-icon.png' } ] } ]
         *     });
         * </script>
         ...
         *     var tree = $('#tree').tree({
         *         imageUrlField: 'icon',
         *         dataSource: [ { text: 'World', icon: 'http://gijgo.com/other/icons/world-icon.png', children: [ { text: 'USA', icon: 'http://gijgo.com/other/icons/usa-oval-icon.png' } ] } ]
         *     });
         * </script>
         */
...
gj.timepicker.methods = {
    ...
    update: function ($timepicker, $clock, data) {
        ...
        // update the numbers
        visualHour = (data.mode === 'ampm' && hour > 12 ? hour - 12 : (hour == 24 ? 0 : hour));
