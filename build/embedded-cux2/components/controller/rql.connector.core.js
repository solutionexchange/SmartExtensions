...
class rqlConnector {
    ...
    constructor(_baseHref, _connectorMode) {
        ...
        this.info = {
            package: {
                name: `embedded-cux2`,
                extensions: `Package-Embedded.xml`,
...
function createRqlConnector(requestParam, callbackFunc) {
    ...
    if (Cookies.get(`rql.connector.js-embedded-cux2`)) {
        var connectorCookie = JSON.parse(Cookies.get(`rql.connector.js-embedded-cux2`));
    } else {
        var connectorCookie = {
            release: `0.0.0.0`
        }
                                                    ...
                                                    getServerVersion(
                                                        ...
                                                        function (responseData) {
                                                            ...
                                                            setProgress({
                                                                ...
                                                                function () {
                                                                    Cookies.set(
                                                                        `rql.connector.js-embedded-cux2`, {
