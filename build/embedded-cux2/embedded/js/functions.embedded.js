...
$(document)
    .ready(
        function () {
            ...
            createRqlConnector({
                    DebugMode: true,
                    BaseHref: "/CMS/Plugins/embedded-cux2",
                ...
                .on(
                    ...
                    function () {
                        if ($(this).prop("checked")) {
                            ...
                            $("body").attr("_lang-embedded", $("body").attr("lang-embedded")).removeAttr("lang-embedded");
                            ...
                            $("body").attr("lang-embedded", $("body").attr("_lang-embedded")).removeAttr("_lang-embedded");
